...
- **Open**: The reShapr community strives to be open, accessible and welcoming to everyone. Anyone may contribute, and contributions are available to all users according to open source values and licenses.
- **Transparent** and **accessible**: Any changes to the reShapr source code and collaborations on the project are publicly accessible (GitHub code, issues, PRs, and discussions).
- **Merit**: Ideas and contributions are accepted according to their technical merit and alignment with project objectives, scope, and design principles.
- **Vendor-neutral**: reShapr is designed and maintained to be fully aligned with the [principles](https://contribute.cncf.io/maintainers/community/vendor-neutrality/) of the Cloud Native Computing Foundation (CNCF).

Join us 👉 https://reshapr.io/community/

## Maintainers, Code Owners, Contributors and Adopters

The reShapr project has four roles. All project members operate in one (or more) of these roles:
...
- Maintainer and Code Owners list: [MAINTAINERS.md](https://github.com/reshaprio/.github/blob/main/MAINTAINERS.md)
- Contributors list: (GitHub) [contributors on reShapr main repo](https://github.com/reshaprio/reshapr/graphs/contributors).
- Adopters (public) list: https://github.com/reshaprio/.github/blob/main/ADOPTERS.md
